; ModuleID = 'testing/output/clava//c11/keywords/_Thread_local/src.c/src.cpp'
source_filename = "testing/output/clava//c11/keywords/_Thread_local/src.c/src.cpp"
...
declare i32 @wait(i32* noundef) #3
